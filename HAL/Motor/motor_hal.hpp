...
public:
    ...
    /**************************************************سيبك من كل الهرى تمام الهارد تمام ودلوقتى الكلام دا بيةلع الاوتبوت ال معاه وانا عاوزه اعدل الكود لما اقوله اتحرك قدام يبقى قدام مش يلف وهكذا عاوزه ابسط تعديل فد الكود او قولى ايه ال بسعمل مدا بالظبط*************
     * Method: motorInit
     * Description:
